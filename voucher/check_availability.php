...
$db_handle = new DBController();
  ...
  $ppl_reserved = $_POST['ppl'];
  
  // sanitizing input
  $voucher_code = mysqli_real_escape_string
   ($db_handle->conn, $voucher_code);
  $ppl_reserved = mysqli_real_escape_string
   ($db_handle->conn, $ppl_reserved);
  $game = mysqli_real_escape_string
   ($db_handle->conn, $_POST['gamename']);
